/* =============================================
   ...
   function showIntroModal(data) {
     ...
     var guideUrls = {
       'build-a-sentence':    'writing/build-a-sentence.html',
       'write-email':         'writing/write-an-email.html',
       'academic-discussion': 'writing/academic-discussion.html'
     };
     var guideBtn = document.getElementById('modalGuideBtn');
     if (guideBtn && guideUrls[data.taskType]) {
       guideBtn.href = guideUrls[data.taskType];
